...
public class UUIDUtil {
	...
	private static final long BASE_TIME = 1262275200000L; // new Date(2010, 0,
															// 1, 0, 0, 0, 0)
	...
	public static long calcId32() {
		...
		if (lastId32Time == id32Time) {
			// last calculation was in the same second, we go into next
			// incremental
			lastId32Incremental++;
		} else {
	...
	/**
	 * 
	 * @return 32 character UUID containing only lower case alpha-numeric
	 *         characters.
	 */
