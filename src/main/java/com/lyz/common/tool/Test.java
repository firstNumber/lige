...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		// public UserInfo(Integer userId, String username, Date
		// birthDate,Integer age, float fRate, char ch)
		SimpleDateFormat formater = new SimpleDateFormat("yyyy-MM-dd");
		UserInfo user1 = new UserInfo(3, "bbb", formater.parse("1980-12-01"), 1, 1.2f, 'a');
		UserInfo user2 = new UserInfo(0, "bbb", formater.parse("1900-10-11"), 03, -3.6f, 'c');
		UserInfo user3 = new UserInfo(12, "5", formater.parse("1980-12-01"), 15, 1.2f, 'f');
